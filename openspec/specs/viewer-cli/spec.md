# viewer-cli Specification

## Purpose
The globally-installed `opsx-ui` command that launches the local viewer server, resolves which OpenSpec project to open (current directory, global picker, or a registered store), and opens the browser.
